...
public class ClubDAOImpl implements ClubDAO {
	...
	public InputStreamResource getImage(int clubId, String type) throws NoSuchFileFoundException {		
		var imgFile = new ClassPathResource(rootLocationClassResource + "/" + type+"/"+clubId+".jpeg");
		if(!imgFile.exists()) imgFile = new ClassPathResource(rootLocationClassResource + "/" + type+"/"+clubId+".jpg");
		if(!imgFile.exists()) imgFile = new ClassPathResource(rootLocationClassResource + "/" + type+"/"+clubId+".png");
	...
	public void saveImage(int clubId, String type, MultipartFile file) {
		...
		Path finalLocation = Paths.get(rootLocation.toString()+"/" + type + "/");
